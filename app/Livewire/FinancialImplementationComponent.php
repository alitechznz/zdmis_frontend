...
class FinancialImplementationComponent extends Component
{
    ...
    public $total_funding_amount, $financing_agreement_dis, $concept_note_id, $outcome_proposal_id, $outcome, $output_proposal_id, $amount, $output, $conceptNoteId, $conceptNote, $activity_proposal_id, $activity, $requested_amount, $percent_requested, $finance_id, $finance_doc_id, $concept_note = null;
    ...
    {
        $this->reset('concept_note', 'outcome', 'output', 'activity', 'requested_amount', 'percent_requested', 'update');
        $this->update = false;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.financial-implementation-component', [
