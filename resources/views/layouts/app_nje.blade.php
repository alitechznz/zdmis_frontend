...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <div class="page-body-wrapper">
            <!-- Page Sidebar Start-->
            @include('livewire.page-za-nje.heade-component')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
                @yield('content')
                {{ $slot ?? '' }}
            ...
            @include('livewire.page-za-nje.footer-component')
        </div>
    </div>
    ...
    <script>
        ...
        window.addEventListener('swal:success', event => {
            toastMixin.fire({
                animation: true,
                icon: 'success',
                title: '<b style="font-size:12pt!important; margin-left: 10px;">' + event.detail.title +
                    '</b>'
            });
        })
