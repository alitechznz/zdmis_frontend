    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6 p-0">
                <h3>Manage Appraisal Question</h3>
            </div>
            {{-- <div class="col-sm-6 p-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Appraisal Question</li>
                </ol>
            </div> --}}
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-sm table-hover table-striped table-responsive custom-scrollbar-sm">
                ...
                <tr class="text-capitalize">
                    ...
                    {{-- </th><th @click="sortByColumn" class="cursor-pointer select-none">Page <span class="float-end text-secondary">&#8645;</span> --}}
                    </th><th @click="sortByColumn" class="cursor-pointer select-none">Section_Title <span class="float-end text-secondary">&#8645;</span>
                ...
                <tbody x-ref="tbody">
                @php $sn = 1; @endphp
                @forelse ($appraisalquestions as $appraisalquestion)

                <tr>
                    <td>{{ $sn }}</td>
                    <td>{{ $appraisalquestion->section }}</td>
                    <td>{{ $appraisalquestion->title }}</td>
                    <td style="display: flex; gap:5px;">
                        @can('edit appraisal question')
                        <a href="#" wire:click="edit({{ $appraisalquestion->id }})"
                            class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#modal-projectquestion">
                             Edit </a>
                        @endcan
                        @can('delete appraisal question')
                        <a href="#" class="btn btn-sm btn-danger" wire:click="deleteConfirm({{$appraisalquestion->id}})"
                            data-bs-toggle="modal" data-bs-target="#deleteModalprojectquestion">
                             Delete </a>
                        @endcan
                ...
                <div class="modal-body">
                    <div  class="row">
                        ...
                        <div class="mb-4 col-md-12 col-sm-12 col-lg-12">
                            ...
                            <input type="text" wire:model="sub_section" class="form-control @error("sub_section") is-invalid @enderror" id="sub_section" placeholder="Enter Sub Section Title">
                            @error("sub_section")
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <!-- Hidden page input -->
                        <input type="hidden" wire:model="page" value="appraisal">

                        <div class="mb-4 col-md-6 col-sm-6 col-lg-6">
                            <label for="title">Question Number <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-4 col-md-12 col-sm-12 col-lg-12">
                            <label for="score_weight">Score Weight</label>
