                ...
                <div class="table-responsive custom-scrollbar">
                    <table class="table table-bordered table-sm table-hover table-striped table-responsive custom-scrollbar-sm">
                        ...
                        <tr class="text-capitalize">
                            ...
                            <th scope="col">Project<small class="text-light">_</small>Time<small class="text-light">_</small>Frame</th>
                            <th scope="col">Project<small class="text-light">_</small>Code</th>
                            <th scope="col">Project<small class="text-light">_</small>GFS<small class="text-light">_</small>Code</th>
                        ...
                        <tbody>
                            @forelse ($conceptnote as $conceptnote_item)
                                <tr>
                                    ...
                                    <td class="text-nowrap">{{ date('Y-m-d', strtotime($conceptnote_item->startdate)) }} - {{ date('Y-m-d', strtotime($conceptnote_item->enddate)) }}
                                    </td>
                                    ...
                                    <td style="display: flex; gap: 5px;">
                                       ...
                                       @can('view concept note approval')
                                        <a href="{{ route('concept-note-screening-report', $conceptnote_item->id) }}" class="btn btn-sm btn-success" style="width:180px;">Screening Report</a>
                                       @endcan

                                        <!-- Link to the Edit page -->
                                        @can('propose  concept note')
                                            <a href="{{ route('proposal-form', $conceptnote_item->id) }}" class="btn btn-sm btn-primary">Propose</a>
                                        @endcan
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="text-danger text-center"> No Approved Concept Note</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
