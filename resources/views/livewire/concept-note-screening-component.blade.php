                          ...
                          <div class="card">
                            ...
                            <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon" data-bs-parent="#accordion">
                              <div class="card-body filter-cards-view animate-chk">
                                ...
                                {{-- <button class="btn btn-success text-center" type="button" data-bs-toggle="modal" data-bs-target="#modal-view-concept-note"
                                    wire:click="loadConceptNote({{ $conceptNote->id }})" style="margin-top:2%;">View Screening Result</button><br />
                ...
                <div class="card">
                  <div class="job-search">
                    <div class="card-body">
                      ...
                      <form style="margin-top: 40px;" wire:submit.prevent="saveProjectDetails">
                        ...
                        @foreach ($questions as $question)
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="radio" wire:model.defer="answers.{{ $question->id }}" value="yes" id="question{{ $question->id }}_yes">
                                    <label for="question{{ $question->id }}_yes">Yes</label>
                                    <input type="radio" wire:model.defer="answers.{{ $question->id }}" value="no" id="question{{ $question->id }}_no">
                                    <label for="question{{ $question->id }}_no">No</label>
                                </div>
                                <textarea class="form-control" wire:model.defer="comments.{{ $question->id }}" id="comment{{ $question->id }}" placeholder="Enter comment"></textarea>
                        ...
                        <button type="submit" class="btn btn-success" wire:loading.attr="disabled">
                            <i class="fa fa-save"></i> Submit Screening
                        </button>
                    </form>
