<div x-data="data()" class="m-2">
                            ...
                            <tr>
                                ...
                                <td style="display: flex; gap: 5px;">
                                    ...
                                    @can('delete department')
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#deleteModaldepartment">
                                        Delete
                                    </a>
                                    @endcan
    ...
    <!-- Modal Content -->
<div class="modal fade" wire:ignore.self id="modal-department" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <input type="text" wire:model="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Department Name">
                        @error('name')
                    ...
                    <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <select id="status" class="form-control @error('status') is-invalid @enderror" onchange="toggleDropdowns()" wire:model='status'>
                    ...
                    <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <select id="under" class="form-control @error('under') is-invalid @enderror" onchange="toggleDropdowns()" wire:model='under'>
                            <option value="">--Choose--</option>
                    ...
                    <div class="mb-4 col-sm-12 col-md-12 col-lg-12" id="institution-dropdown" style="display: none;">
                    ...
                    <div class="mb-4 col-sm-12">
                        ...
                        <textarea id="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter Address" wire:model='address' ></textarea>
                        @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
...
<script>
    function toggleDropdowns() {
        ...
        document.getElementById('institution-dropdown').style.display = (underValue === 'Institution') ? 'block' : 'none';
