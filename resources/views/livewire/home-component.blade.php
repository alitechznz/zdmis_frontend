                      ...
                      <div class="row">
                        <div class="col-xl-4 xl-8 col-md-4 col-sm-8 col box-col-8">
                          <div class="d-flex up-sales">
                            <div class="flex-shrink-0">
                              <h4>{{ $t_proposal }}</h4>
                              <h6>Total Project Proposal</h6>
                              <div class="arrow-chart">
                                <div style="display: flex; justify-content: center;">
                                    <i class="fa fa-file fa-3x" aria-hidden="true"></i>
                                </div>
                                <h5 class="font-success">{{ $p_proposal }}% / concept note</h5>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-xl-8 xl-12 col-md-8 col-sm-12 col box-col-12">
                          <div class="d-flex total-customer">
                            <div class="flex-shrink-0">
                              <h4>{{ $t_project }}</h4>
                              <h6>Total National Projects</h6>
                              <div class="arrow-chart">
                                <div style="display: flex; justify-content: center;">
                                    <i class="fa fa-tasks fa-3x" aria-hidden="true"></i>
                                </div>
                                <h5 class="font-success">{{ $p_project }}% out of proposal</h5>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-xl-8 xl-12 col-md-8 col-sm-12 col box-col-12">
                            <div class="d-flex">
                              ...
                              <div class="flex-shrink-0">
                                <h4>{{ $t_lga }}</h4>
                                <h6>Total LGAs Project </h6>
                                <div class="arrow-chart">
                                    <div style="display: flex; justify-content: center;">
                                        <i class="fa fa-tasks fa-3x" aria-hidden="true"></i>
                                    </div>
                                  <h5 class="font-success">{{ $t_lga }}%</h5>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-xl-4 xl-8 col-md-4 col-sm-8 col box-col-8">
                            <div class="d-flex up-sales">
                              <div class="flex-shrink-0">
                                <h4>{{ $t_ppp }}</h4>
                                <h6>Total PPP Project </h6>
                                <div class="arrow-chart">
                                    <div style="display: flex; justify-content: center;">
                                        <i class="fa fa-tasks fa-3x" aria-hidden="true"></i>
                                    </div>
                                  <h5 class="font-success">{{ $t_ppp }}% </h5>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="d-flex total-customer">
                              <div class="flex-shrink-0" >
                                ...
                                <div class="arrow-chart">
                                  ...
                                  <h5 class="font-success">{{ $p_investment }}% </h5>
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <tbody>
                              ...
                              @foreach ($upcomingDeadlines as $deadline)
                                <tr>
                                    ...
                                    <td>{{ $deadline->enddate->format('d M Y') }}</td>
                                    <td>
                                        {{  $deadline->percentage_remaining }}%

                                        <div class="progress">
                                            @if($deadline->percentage_remaining > 70)
                                                <div class="progress-bar bg-success" role="progressbar" style="width: 70%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                            @elseif ($deadline->percentage_remaining < 20)
                                                <div class="progress-bar bg-warning" role="progressbar" style="width: 70%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                            @else
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: 70%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                            @endif
