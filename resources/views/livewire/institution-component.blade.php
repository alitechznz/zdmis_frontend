<div x-data="data()" class="m-2">
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-6">
                    <div class="float-end">
                        @can('add institution')
                            <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modal-institution" wire:click='create'
                        ...
                        <tr>
                            ...
                            <td style="display: flex; gap: 5px;">
                                ...
                                <a href="#" wire:click="edit({{ $institution->id }})"
                                    class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#modal-institution">
                                     Edit </a>
                                @endcan
                                @can('delete institution')
                                     
                                <a href="#" class="btn btn-sm btn-danger" wire:click="deleteConfirm({{$institution->id}})"
                                    data-bs-toggle="modal" data-bs-target="#deleteModalinstitution">
                                     Delete </a>
                                @endcan
    ...
    <!-- Modal Content -->
    <div class="modal fade" wire:ignore.self id="modal-institution" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="h6 modal-title">@if($update) Update @else Add @endif Institution</h2>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div  class="row">
                        <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                            <label for="name">Institution Name <span class="text-danger">*</span></label>
                            <input type="text" wire:model="name" class="form-control @error("name") is-invalid @enderror" id="name" placeholder="Enter Institution Name">
                            @error("name")
                        ...
                        <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input type="text" wire:model="vote_number" class="form-control @error("vote_number") is-invalid @enderror" id="vote_number" placeholder="Enter Vote Number">
                            @error("vote_number")
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-4 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input type="text" wire:model="web_url" class="form-control @error("web_url") is-invalid @enderror" id="web_url" placeholder="eg www.zips.co.tz">
                            @error("web_url")
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-4 col-sm-12 col-md-12 col-lg-12" xmlns="http://www.w3.org/1999/html">
                            ...
                            <textarea wire:model="address" class="form-control @error("address") is-invalid @enderror" id="address" placeholder="Enter Institution Address">
                            </textarea>
                            @error("address")
                            <div class="invalid-feedback">
                                {{ $message }}
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteModalinstitution" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
