<div x-data="data()" class="m-2">
                ...
                <div class="col-6">
                    <div class="input-group">
                        <input type="search" wire:model.live="search_keyword"
                            class="form-control form-control-sm w-auto" placeholder="Search institution...">
                    </div>
                </div>
                <div class="col-6">
                    <div class="float-end">
                        ...
                        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                            data-bs-target="#modal-institution" wire:click='create'><i class="fa fa-plus"></i> Add New
                        </a>
    ...
    <!-- Modal Content -->
    <div class="modal fade" wire:ignore.self id="modal-institution" tabindex="-1" role="dialog"
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteModalinstitution" data-backdrop="false" tabindex="-1"
