                    ...
                    <div class="login-card login-dark">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12 col-sm-12 col-lg-12">
                                <div class="login-main" style="width:70%;height:380px; background-color: #95a5a6;" id="login-main">
                                    <div class="row">
                                            ...
                                            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="{{ asset('assets/images/slide6.jpg') }}" class="d-block w-100" alt="..." style="width:60%; height:300px;">
                                                    </div>
                                        ...
                                        <div class="col-6 col-lg-6">
                                            <div style="margin-top:-30px;"><a class="logo" href=""><img class="img-fluid for-light" style="width:45%;" src="{{  asset('assets/images/smzlogoe.png') }}"><img class="img-fluid for-dark" src="{{  asset('assets/images/smzlogoe.png') }}" style="width:45%;"></a></div>
                                            <form wire:submit="submit" class="theme-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-input position-relative">
                                                        <input class="form-control @error('password') is-invalid @enderror" type="password" wire:model="password" required="" placeholder="Enter your password" style="background-color: white;">
                                                        @error('password')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="text-end mt-3">
                                                        ...
                                                        <button class="btn btn-info btn-block w-40" type="button">Forgot Password</button>
