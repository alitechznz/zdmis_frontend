                ...
                <div class="col-6">
                    <div class="input-group">
                        <input type="search" wire:model.live="search_keyword"
                            class="form-control form-control-sm w-auto" placeholder="Search weather source...">
                    </div>
                </div>
                <div class="col-6">
                    <div class="float-end">
                ...
                <table
                    ...
                    <thead class="table-light">
                        <tr class="text-capitalize">
                            <th>SN</th>
                            <th @click="sortByColumn" class="cursor-pointer select-none">Source_Name <span
                                    class="float-end text-secondary">&#8645;</span>
                            </th>
                            <th @click="sortByColumn" class="cursor-pointer select-none">Source_Type <span
                                    class="float-end text-secondary">&#8645;</span>
                            </th>
                            <th @click="sortByColumn" class="cursor-pointer select-none">Location <span
                                    class="float-end text-secondary">&#8645;</span>
                            </th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-4">
                            <label for="source_type">Source type <span class="text-danger">*</span></label>
                            <select wire:model="source_type"
                                class="form-control @error('source_type') is-invalid @enderror" id="source_type">
    ...
    <div wire:ignore.self class="modal fade" id="deleteModaldistrict" data-backdrop="false" tabindex="-1"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure want to delete <strong>this district</strong>
                        ?
                    </p>
                </div>
                <div class="modal-footer">
